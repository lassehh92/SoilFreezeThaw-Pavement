...
file_path_1 = '/Users/lhh/github-projects/SoilFreezeThaw-Pavement-2/forcings/Haandvaerkervej_Perma_road_SPINUP_03okt2022_to_04jan2023.csv'
df1 = pd.read_csv(file_path_1)
df1['time'] = pd.to_datetime(df1['time'], errors='coerce')

# Load the new CSV file
file_path_2 = '/Users/lhh/github-projects/SoilFreezeThaw-Pavement-2/forcings/Haandvaerkervej_Perma_road_04Jan2023_to_07feb2024_updated.csv'  # Replace with your file path
