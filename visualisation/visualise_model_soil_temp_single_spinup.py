...
# Print column names
print("Simulated data columns:")
for i, col in enumerate(simulated_data.columns):
    print(f"{i}: {col}")
...
# Plot 6cm data
ax1.plot(observed_data.index, observed_data['Observed_Temp_6cm'], label='Observed', color='blue')
...
# Plot 30cm data
ax2.plot(observed_data.index, observed_data['Observed_Temp_30cm'], label='Observed', color='blue')
